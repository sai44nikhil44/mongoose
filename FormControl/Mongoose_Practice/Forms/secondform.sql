...
SET @Sequence = 0
SELECT @FormID=ID FROM Forms WHERE Name = N'secondform' AND ScopeType = 1
...
DELETE FROM ActiveXScriptLines WHERE ScriptName = N'secondform' AND ScopeType = 1
DELETE FROM ActiveXScripts WHERE Name = N'secondform' AND ScopeType = 1
...
VALUES ( 
  1, N'[NULL]', NULL, N'secondform', NULL, 0, NULL, 
  N'secondform(OBJNAME(osecondform))', 
...
INSERT INTO FormComponents (
  ...
  [Description], [EffectiveCaption], [LayoutAttributes] )
VALUES (
  @FormID, N'forthEdit', -1, 
  3, 1, CAST('2.5' AS float), CAST('24' AS float), CAST('1.3' AS float), CAST('0' AS float), CAST('10' AS float), N'C(forthStatic)', 
  NULL, 
  NULL, 0, N'object.forth', 
...
INSERT INTO FormComponents (
  ...
  [Description], [EffectiveCaption], [LayoutAttributes] )
VALUES (
  @FormID, N'thirdEdit', -1, 
  1, 1, CAST('1' AS float), CAST('24' AS float), CAST('1.3' AS float), CAST('0' AS float), CAST('10' AS float), N'C(thirdStatic)', 
  NULL, 
  NULL, 0, N'object.third', 
  1, NULL, NULL, NULL, NULL, NULL, 
  NULL, 
  1, NULL, 0, 0, NULL, NULL, NULL, 0, N'StdDefault', 
  NULL, NULL, NULL, 
